...
| :--- | :--- | :--- | :--- |
| **👨💻 Member 1** | Authentication, Core Infrastructure, Database, Middleware, Layout | `feature/auth-core` | `supabase/*`, `src/utils/supabase/*`, `src/middleware.ts`, `src/app/(auth)/*`, `src/components/layout/*` |
